 ...
 * @LastEditors: 刘帝君
 * @LastEditTime: 2021-11-04 16:30:02
 * @Descripttion: 沟通方式
-->
<template>
  <div>
...
import {
  getCommunicationListAPI,
  changeStateItemAPI,
  addCommunicationAPI,
  editCommunicationAPI,
  deleteItemAPI
} from "@/api/baseSet";
...
export default {
  ...
  setup() {
    ...
    const getList = computed(() => {
      return getCommunicationListAPI;
    });
