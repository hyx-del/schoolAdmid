 ...
 * @LastEditors: 刘帝君
 * @LastEditTime: 2021-11-04 16:29:34
 * @Descripttion: 学员身份
-->
<template>
  <div>
...
import {
  getStudentPositionListAPI,
  changeStateItemAPI,
  addStudentPositionAPI,
  editStudentPositionAPI,
  deleteItemAPI,
  addResrouceTypeAPI,
  editResrouceTypeAPI
} from "@/api/baseSet";
...
import { enableList, enableStatus, getListHtml } from "@/utils/enum/select";
    ...
    const state = reactive({
      ...
      column: [
        { prop: "label", label: "名称" },
        {
          prop: "status",
          label: "状态",
          html: (row, val) => getListHtml(enableList, val)
        },
        {
          prop: "createTime",
          label: "创建时间"
